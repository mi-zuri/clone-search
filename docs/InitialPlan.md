...
Reduce final channels to 320 - The 512→128 embedding projection throws away 75% of information anyway, suggesting 512 is over-parameterized?
Adam optimizer (lr=0.001, wd=0.0001): Standard safe choice, but AdamW with cosine schedule often converges faster?
Efficiency consideration: 7×7 convolutions are 2.25× more expensive than 3×3. Modern architectures (EfficientNet, MobileNet) favor stacked 3×3 convs?
Head weighting in face encoder?
Make sure there is no loss scale imbalance
